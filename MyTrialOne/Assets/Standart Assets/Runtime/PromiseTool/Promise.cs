...
using System.Linq;
using Scripts.Runtime.Modules.Core.PromiseTool.Exceptions;
using UnityEngine;
...
//            Argument.NotNull(() => transform);
    ...
    {
      Promise<PromisedT> promise = new(PromiseState.Resolved);
...
//            Argument.NotNull(() => ex);
      ...
      Promise<PromisedT> promise = new(PromiseState.Rejected);
